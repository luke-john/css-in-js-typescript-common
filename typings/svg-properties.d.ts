import { CSSPropertiesCompleteSingle } from './css-properties'
...
export interface SVGPropertiesCompleteSingle<
    CSSProperties extends { display?: any } = CSSPropertiesCompleteSingle
> {
...
export interface SVGPropertiesLossy<
    SVGPropertiesSet = SVGPropertiesCompleteSingle<CSSPropertiesCompleteSingle>,
    AdditionalSVGProperties = string
>{
    [propertyName: string]:
