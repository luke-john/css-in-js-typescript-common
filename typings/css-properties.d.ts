...
export interface CSSPropertiesCompleteSingle {
    ...
    */
     ...
     */
    wordBreak?: CSSWideKeyword | 'normal' | 'break-all' | 'keep-all'
...
interface CSSPropertiesPseudo<CSSProperties> {
...
// The Additional generic is useful in cases such as glamorous where you have unique valid css
// properties such as arrays, we use a string default for where it's not used.
export interface CSSPropertiesLossy<
    CSSPropertiesSet = CSSPropertiesCompleteSingle,
